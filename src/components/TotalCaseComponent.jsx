        ...
        <div className="container fluid">
            <div className="container-md">
                <div className="row row-cols-3">
                    <div className="col">
                        <Card img={imageLink.world} />
                    </div>
                    <div className="col">
                        <Card img={imageLink.totalCases} />
                    </div>
                    <div className="col">
                        <Card img={imageLink.totalDeaths} />
                    </div>
                    <div className="col">
                        <Card img={imageLink.todayCases} />
                    </div>
                    <div className="col">
                        <Card img={imageLink.recovery} />
                    </div>
                    <div className="col">
                        <Card img={imageLink.todayDeaths} />
                    </div>
                </div>
            </div>
        </div>
